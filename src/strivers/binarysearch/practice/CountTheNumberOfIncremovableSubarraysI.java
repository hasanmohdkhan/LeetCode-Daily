...
public class CountTheNumberOfIncremovableSubarraysI {
    ...
    public static void main(String[] args) {
        CountTheNumberOfIncremovableSubarraysI s = new CountTheNumberOfIncremovableSubarraysI();
        System.out.println("s = " + s.incremovableSubarrayCount(new int[]{1, 2, 3, 4}));
        System.out.println("s = " + s.incremovableSubarrayCount(new int[]{6, 5, 7, 8}));
    }
}
